...
\todo{
This flags section doesn't work well.  Start by mentioning key findings
(link to new end-of-results summary), then flag discussion of these
in context of literature.  Finally, implications for management outcomes;
and flag further research in conclusions.
}
...
\todo{
Add about a page total to 5.1 --
``discussion of how your results fit into the context of other studies in Aus
and elsewhere.  And how your methodology adds to what has been done before.
This needs explicit references to the literature -- (J).  ESSENTIAL
}
...
\todo{(D) add crisp statement of my unique or distinctive findings
(J) `This research has achieved...'
}
...
\begin{figure}[p]
    ...
    \caption[Three ways to characterise timing of seasons, Galiwinku]{
        ...
        \todo{add small colour key in, shrinking if required}
        }
...
\todo{key reference: white paper on North Aus development.
Also check RIEL at CDU for publications}
...
Knowledge and cutting-edge fire science \todo{REFS -- eg Cary et al, David Bowman}.

\todo{more refs in this para (both IK-related and not)}
...
enterprises.
%
\todo{what about pastoral management, organics, biodiversity?
Check Bruce Doran's research with students in NW WA.}
%
...
\todo{review / move below, to nail conclusion}
