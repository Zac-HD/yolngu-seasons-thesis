...
\todo{
Start more specific, by addressing research questions then aims.
(then findings -- contributions -- further research (from disc.) -- implications).
}
...
\todo{move further research section to here.  Conclusion can be 3-4 pages.}
