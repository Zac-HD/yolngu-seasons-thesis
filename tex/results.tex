...
month at Galiwinku.  \Cref{fig:galiwinku-climograph} is a monthly
...
%
Wind vectors, \cref{fig:galiwinku-wind-vectors}, show the typical wind direction
and speed by month.
...
\vspace{1cm}
    ...
    \caption[Monthly wind vector summary for Galiwinku]{
        ...
        lines shows the proportion of wind (length of line) coming from
        the corresponding point of the compass, with colours as given
        by \cref{fig:compass-rose}.}
...
\begin{SCfigure}[][h]
    ...
    \caption[Compass Rose mapping colour to wind direction]{
        ...
        These colours are equidistant in the HSL colour space,
...
\Cref{fig:galiwinku-observations,fig:milingimbi-observations}
show weather observations at Galiwinku and Milingimbi as a set of
...
\todo{write clear explanation that there are two distinct ways that
`seasonal intensity' are presented: by index, and by occurance.
Group figure references this way, and note the clear links from
bluepanels to indexlines, and the equal-proportional-area in
pie, probability, and top heatmap.
}
...
\Cref{fig:season-daily-index} is a line chart, showing the mean
