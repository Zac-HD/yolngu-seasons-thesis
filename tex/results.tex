...
TODO - outline variability in timing, WITH QUOTES, multiple-onset, etc.
...
\autoref{sec:further-study} discusses how these seasons might be explored
...
with \autoref{sec:complex-seasons} -- avoids misleading similarities to
...
One participant read \autoref{fig:yolngu-seasons} as claiming Rarrandharr
...
a fire to stay warm is very difficult, and TODO MORE QUOTES HERE.
...
\autoref{fig:yolngu-seasons} \citep{davis1989}, but was described by
participants and appears in the \textit{Yan-nhangu Atlas}.  Mayaltha's
place in the three-level taxonomy of seasons (\autoref{subsec:three-seasons-scales})
...
TODO - should I reproduce the climograph here?  Or is a reference enough?
...
TODO - landscape table is larger and uglier than ideal.  Short column
...
TODO - write detailed walkthrough of how to read these figures!
...
\autoref{tab:quant-seasons-summary} summarises typical timing and recognition
criteria for each season.  \label{fig:season-definitions-code} shows the
implementation of these conditions in Python3 code -- normalised later --
which create the time-series shown in figures \ref{fig:galiwinku-seasons}
and \ref{fig:milingimbi-seasons}.
...
\begin{wrapfigure}{R}{0.5\textwidth}
    \centering
    \includegraphics[width=\linewidth]{galiwinku/season-counts.pdf}
    \caption[Calculated season frequency, Galiwinku]{
        Number of days on which each season was observed at Galiwinku,
...
TODO:  Write interpretative para/s for index lines and observed area.
Also sort out figure sizes and formatting?

TODO:  Work out formatting and write paragraph/s interpreting multipanel season figs

TODO:  Close chapter with a table (or similar) presenting seasons, detection
