...
but may be of interest when planning future research.
...
\item[Extreme Events]
    ...
    Extreme events only contribute to the definitions of the meteorological
    calendar described above through the conditions themselves.
...
\item[Climate Change]
    ...
    environmental change, including weather, which \citet[consistent with][]{petheram2010}
    was mostly attributed to local impacts.
...
vectors showing proportional occurence of wind from each direction by month
and time of day.  Note the low variation in temperature, and strong seasonal
patterns in rainfall and humidity in the climograph, and the monsoonal wind
...
\begin{SCfigure}[][b]
    \includegraphics[width=0.35\linewidth]{compass-rose.pdf}
...
manifests in mixed occurence shown on the top (detected season) panel, and
...
The second method considers \emph{frequency of season occurence}, shown by
...
of 10-15 years.
%
Unlike the index lines, these areas are not independent -- if one season was
...
which clearly shows variability between years or `strong second' finishes on a given day.
...
\vspace{1cm}
    ...
    \caption[Season probability by day-of-year, Galiwinku]{
        ...
        detection, true variation in seasonal occurence, and details
        lost in aggregation.
        The colour scheme is given by \cref{fig:galiwinku-season-pie}.
        }
