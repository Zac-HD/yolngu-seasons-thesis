...
One participant described eager anticipation of the season
...
(dhimurru). ... The [easterly] wind dhimmurru/bulunu is associated with white berries
...
\todo{re-write this para, and restructure up to floatbarrier for clarity and flow.}

The figures in this section may be characterised in terms of two distinct but related categories.
Understanding the distinction and the relationship between these categories is crucial
for accurate interpretation, as each summarise the data shown in
...
\todo{pull out equal-area stuff, and use at end to draw connections}
...
\todo{summary paragraph for findings of this section
%
Those findings are:
- seasons can be detected based on the OWR
- detection works well for dry seasons, moderately for wet (possibly due to rainfall variability)
- structure is consistent with known Yolngu understanding
- representing seasonal occurance is complicated and there are multiple options
}
