...
weather station in the study area (included in the electronic appendicies).
...
recruitment followed \todo{REF} a `snowball' pattern, where participants
were asked to suggest further potential participants.  The `seeds' of
this pattern were personal contacts in the Uniting Church, and the
