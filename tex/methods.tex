...
My methodological approach is interdisciplinary and exploratory.
%
The interdisciplinary aspect is inherent in the topic; it would
...
TODO - reference \autoref{subsec:three-seasons-scales}
regarding multiple timescales for seasons and flag exclusive
focus on one.  All laid out there, but need a reference in methods.


\paragraph{Observing seasonal onset}~\\
\textit{This subsection is not yet finalised.}\\
