...
or at least unequal benefits, where researchers come and go but leave nothing
...
to the study area.
%
\todo{explain this was to provide validation data, as the record is too
short to do a training/validation split temporally.  As later results
show that this data is too spatially distinct for a localised calendar,
these analyses may be found in the electronic appendices.
}
...
%
This section describes the basic numerical data, quality checks, and handling of missing data.
...
Yolngu participants suggested that season detection should not consider 3pm wind
