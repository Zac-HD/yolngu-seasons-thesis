...
\todo{short bit on non-Aus context; may not be about climate, may merge with para below}

\defcitealias{BOM-iwk}{BoM 2016}

Previous research on Australian Indigenous calendars \citepalias[eg.][]{BOM-iwk},
