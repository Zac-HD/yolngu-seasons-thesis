...
% get at idea that western approaches are suboptimal or insufficient - growing rec
% of indig k and potential to learn from and implement the lessons of
% THEN
% Aus has a wealth of IK to draw on, and one way is to get a handle on natural cycles and
% how these have played into land and NRM.  Seasons are key; four seasons have been
% imposed but there are other and better ways.
%
% THis thesis is an embodyment of how to bring both IK and western science togther,
% and so enrich both.


%%%%%%%%%      Australia is hard; env. management is important       %%%%%%%%%%%
...
~\\ \hrule ~\\
%%%%%%%%%      We do env. management badly; can learn from indig. knowledge       %%%%%%%%%%%
...
% then really cover the existing research
