...
\todo{Rewrite / restructure subsection and remove header}


% What are the key points here?
%
% - I'm doing cross-cultural research with indigenous people (it's hard -- Petheram, Woodward)
% - Important to do this in a respectful way due to history
% - Key methodology references:  post-colonial, relationship-based,
%       two-ways.  Inc. leaching poison -- Yolngu-specific
% - Contextualise: my methods take a two-ways approach, within logistical
%       constraints.  Possible because this is pat of an ongoing relationship.
%
...
\todo{Refs: \citet{sultan2003,fasullo2002,wu1998,hendon1990}
discuss monsoon basics and quantification.
}
